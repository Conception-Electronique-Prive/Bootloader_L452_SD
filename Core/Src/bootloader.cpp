...
uint8_t Bootloader_Erase(void) {
    ...
    pEraseInit.Page      = (APP_ADDRESS - BOOTLOADER_ADDRESS) / FLASH_PAGE_SIZE;
...
uint32_t Bootloader_GetVersion(void) {
    return ((BOOTLOADER_VERSION_MAJOR << 24) | (BOOTLOADER_VERSION_MINOR << 16) | (BOOTLOADER_VERSION_PATCH << 8) |
