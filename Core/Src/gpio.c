...
void MX_GPIO_DeInit(void) {
    HAL_GPIO_DeInit(GPIOB, uSD_Detect_Pin | LED_2_Pin | LED_1_Pin);
    HAL_GPIO_DeInit(uSD_CS_GPIO_Port, uSD_CS_Pin);
    HAL_GPIO_DeInit(uSD_Detect_GPIO_Port, uSD_Detect_Pin);
