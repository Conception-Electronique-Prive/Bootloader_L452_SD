...
#define FCLK_FAST()                                                                                \
    ...
    } /* Set SCLK = fast, approx 10 MBits/s */
...
)
{
    ...
    // TODO This function does not seem to work as intended...
    //    HAL_Delay(5);
    //    return 1;
}
...
)
{
    ...
    FCLK_SLOW();
    // To put the SD card into SPI mode, we must send at least 79 clock cycles with MOSI and CS
    // HIGH.
    CS_HIGH();
    for (n = 10; n; n--)
